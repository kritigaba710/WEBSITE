...
const BMIcard = () => {
  ...
  return (<>
    <div className='flex items-center justify-center gap-10 py-10 flex-wrap md:flex-nowrap' ref={ref}>
      <div className='flex flex-col justify-center items-center gap-5'>
        ...
        >
          ...
          <div className='text-[#4f4a36cc] font-semibold'>Measure of weight relative to height</div>
      ...
      >
        <img src="/bmi.png" width={250} height={250} alt="BMI Calculator" />
      </motion.div>
    </div>
