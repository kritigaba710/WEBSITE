...
const Hero = () => {
  ...
  return (
      <div className="relative overflow-hidden min-h-screen text-[#4f4a36cc] bg-transparent px-4">
        
        <div className="absolute top-48 left-0 w-full h-[300px] z-0 pointer-events-none">
        ...
        <div className="mt-20 flex flex-col gap-4 text-center z-10 relative max-w-3xl mx-auto">
          <FloatingBubbleText className="text-2xl md:text-4xl font-bold">
            LET'S START TAKING CARE OF YOUR
          </FloatingBubbleText>
          <FloatingBubbleText className="text-4xl md:text-7xl font-bold font-serif">
            HEALTH & FITNESS
          </FloatingBubbleText>
          <FloatingBubbleText className="text-lg md:text-2xl font-semibold">
