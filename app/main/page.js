...
export default function MainDashboard() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br pt-5 from-[#ddb27b] via-[#c29073] to-[#dfb288]">
      <Navbar />
      <div className="mt-8 mx-4 rounded-4xl font-bold mb-6 text-center shadow-lg overflow-hidden relative h-[30vh] sm:h-[35vh] md:h-[40vh] lg:h-[45vh] p-8 sm:pt-12 md:p-20 lg:p-24 text-3xl sm:text-4xl md:text-6xl lg:text-7xl bg-[url('/mainbg.jpg')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="footer h-20 mt-10 text-center text-lg font-semibold shadow-2xl text-slate-950 p-5 bg-[#c98e6c]">
        All Copyrights to kritigaba31@gmail.com
      </div>
    </main>
  );
}
